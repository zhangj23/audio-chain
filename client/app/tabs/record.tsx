...
export default function RecordScreen() {
  ...
  // Get selected group from real data
  ...
  const handlePressIn = async () => {
    ...
    if (!selectedGroup) {
      Alert.alert("No Group Selected", "Please select a group to record for.");
      return;
    }
  ...
  const submitVideo = async () => {
    if (!recordedVideoUri || !selectedGroup) return;
                    ...
                    >
                      ...
                      {group.description && (
                        <View style={styles.descriptionSection}>
                          <ThemedText style={styles.groupCardDescription}>
                            {group.description}
                          </ThemedText>
                        </View>
                      )}
